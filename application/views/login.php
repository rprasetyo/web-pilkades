			...
			<div class="login-content">
				<form id="form_login" action="<?php echo $base_url_int;?>home/login_validation" method="POST" class="margin-bottom-0">
					<div class="form-group m-b-20">
						<input type="text" name="username" class="form-control form-control-lg" placeholder="ini user -> admin@gmail.com" required />
                        <input type="hidden" name="<?php echo $csrf['name'];?>" value="<?php echo $csrf['hash'];?>" />
					</div>
					<div class="form-group m-b-20">
						<input type="password" name="password" class="form-control form-control-lg" placeholder="ini password -> pilkades2020" required />
					</div>
