...
<head>
    ...
    <meta name="description"
          content="Web Informasi Pilkades PILKADES <?php echo $sis_pem . ' ' . $desa . ' Kecamatan ' . $kec . ' ' . $sis_kabkot . $kabkot; ?>">

    <!-- Google / Search Engine Tags -->
    <meta itemprop="name" content="PEMDES | <?php echo $desa; ?>">
    <meta itemprop="description"
          content="Web Informasi PILKADES <?php echo $sis_pem . ' ' . $desa . ' Kecamatan ' . $kec . ' ' . $sis_kabkot . $kabkot; ?>">
    <meta itemprop="image"
          content="<?php echo base_url(); ?>assets/img/kegiatan/400/02029138-5e62-40b9-bdca-97cefed55e8c.jpg">
    ...
    <link href="<?php echo base_url(); ?>themes/frontend/css/one-page-parallax/style-responsive.min.css"
          rel="stylesheet"/>
    <link href="<?php echo base_url(); ?>themes/frontend/css/one-page-parallax/theme/default.css" id="theme"
          rel="stylesheet"/>
...
<div id="page-container" class="fade">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header-navbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#pilkades" data-click="scroll-to-target"
                           data-scroll-target="#pilkades" data-toggle="dropdown">PILKADES <b class="caret"></b></a>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#perangkat" data-click="scroll-to-target">Perangkat
                            Desa</a></li>
    ...
    <div id="home" class="content has-bg home">
        <div class="content-bg"
             style="background-image: url(<?php echo base_url(); ?>/themes/frontend/img/bg/bg-home.jpg);"
             data-paroller="true"
             data-paroller-factor="0.5"
             data-paroller-factor-xs="0.25">
        </div>
        <div class="container home-content" style="top: 40%;">
            <img src="<?php echo base_url('assets/img/logo/' . $logo_kab); ?>" width="150px"
                 alt="logo-kabupaten-<?php echo strtolower($kabkot); ?>">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="team p-l-10 p-r-10">
                                <div class="image" data-animation="true" data-animation-type="flipInX">
                                    <img src="assets/img/photo/128/<?php echo $value['photo']; ?>"
                                         alt="<?php echo $value['nama']; ?>"/>
                                </div>
                                <div class="info">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 form-col" data-animation="true" data-animation-type="fadeInRight">
                        <form id="form_cek" autocomplete="off" action="<?php echo base_url('home/cek_pemilih'); ?>"
                              class="form-horizontal" method="POST">
                            <div class="form-group row m-b-15">
                                <label class="col-form-label col-md-3 text-md-right">NIK <span
                                            class="text-theme">*</span></label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control form-control-lg" placeholder="NIK KTP"
                                           name="nik_ktp"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-9 text-left">
                                    <button id="btn_form" type="submit" class="btn btn-theme btn-block">Cek Data
                                    </button>
                                </div>
                            </div>
                        </form>
        ...
        <div class="container" data-animation="true" data-animation-type="fadeInDown">
            <div class="row text-center">
                <div class="col-md-6 form-col" data-animation="true" data-animation-type="fadeInRight">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/xBMIBoQxZ6E" frameborder="0"
            ...
            <div class="row row-space-10">
                ...
                foreach ($dok_kegiatan->result_array() as $key => $value) { ?>
                    <div class="col-md-4 col-sm-6">
                        <div class="work">
                            <div class="image">
                                <a href="<?php echo base_url('assets/img/kegiatan/800/' . $value['filename']); ?>"
                                   data-fancybox="gallery"><img
                                            src="<?php echo base_url('../assets/img/kegiatan/400/' . $value['filename']); ?>"
...
<div id="footer" class="footer">
    <div class="container">
        <div class="footer-brand">
            <div class=""><img src="<?php echo base_url('assets/img/logo/' . $logo_kab); ?>"
                               alt="icon-kabupaten-<?php echo strtolower($kabkot); ?>" width="80px"></div>
